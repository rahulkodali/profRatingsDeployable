...
function App() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const reviewResponse = await axios.post('http://localhost:5001/api/reviews', { name });
      ...
      if (reviewResponse.data.reviews.length === 0) {
        ...
        const summaryResponse = await axios.post('http://localhost:5001/api/summary', { reviews: reviewResponse.data.reviews });
